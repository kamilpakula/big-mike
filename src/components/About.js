...
import image_project from "../images/image_project.png";
        ...
        <section className="about">
            <section className="about__projects">
                ...
                <div className="about__heading">
                    <span className="about__span">P R O J E K T Y</span>
                </div>
            </section>
            <section className="about__other">
